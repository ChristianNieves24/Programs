...
3) SXM_Data_Notebook (Jupyter Notebook)
    - Contains everything in 'flight_spare_data_plots.py' along with additional code for plotting
    
----------------------------
Folders
----------------------------
1) flight_spare_data
    - All the files, including '.h5' files, produced with 'parse-h5_tlm-log_files'
2) plotFigs
